...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-primary-50 mt-auto to-primary-100 py-12 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <Text className="text-gray-400">{t("footer.copyright")}</Text>
        </div>
      </div>
    </footer>
  );
