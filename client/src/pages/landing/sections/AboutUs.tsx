...
import { CrownOutlined, SafetyOutlined, StarOutlined, TrophyOutlined } from '@ant-design/icons';
...
const AboutUs: React.FC = () => {
  ...
  return (
    <section id="about-us" className="py-20 bg-gradient-to-br from-white to-primary-50">
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <Title level={1} className="text-5xl font-bold bg-gradient-to-r from-primary-600 to-primary-400 bg-clip-text text-transparent mb-6">
            ...
            <Col xs={24} lg={12}>
              <div className="mb-8 lg:mb-0">
                ...
                <div className="flex justify-center space-x-8 text-center">
                  <div>
                    <Title level={3} className="text-primary-600 font-bold mb-2">50+</Title>
                    <Paragraph className="text-gray-600">{t('aboutUs.stats.years')}</Paragraph>
                  </div>
                  <div>
                    <Title level={3} className="text-primary-600 font-bold mb-2">10K+</Title>
                    <Paragraph className="text-gray-600">{t('aboutUs.stats.customers')}</Paragraph>
                  </div>
                  <div>
                    <Title level={3} className="text-primary-600 font-bold mb-2">99%</Title>
                    <Paragraph className="text-gray-600">{t('aboutUs.stats.satisfaction')}</Paragraph>
                  </div>
                </div>
              </div>
            </Col>
